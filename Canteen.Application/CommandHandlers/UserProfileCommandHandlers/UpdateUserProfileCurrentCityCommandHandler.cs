...
{
    public class UpdateUserProfileCurrentCityCommandHandler
     : BaseUserProfileCommandHandler, IRequestHandler<UpdateUserProfileCurrentCityCommand, OperationResult<UserProfile>>
    {
        public UpdateUserProfileCurrentCityCommandHandler(IMongoGenericRepository<UserProfile> userProfileRepository)
        ...
        public async Task<OperationResult<UserProfile>> Handle(
            UpdateUserProfileCurrentCityCommand request,

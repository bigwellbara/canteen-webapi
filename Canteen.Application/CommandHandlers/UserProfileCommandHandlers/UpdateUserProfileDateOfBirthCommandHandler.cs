...
{
    public class UpdateUserProfileDateOfBirthCommandHandler
       : BaseUserProfileCommandHandler, IRequestHandler<UpdateUserProfileDateOfBirthCommand, OperationResult<UserProfile>>
    {
        public UpdateUserProfileDateOfBirthCommandHandler(IMongoGenericRepository<UserProfile> userProfileRepository)
            : base(userProfileRepository) { }

        public async Task<OperationResult<UserProfile>> Handle(
            UpdateUserProfileDateOfBirthCommand request,
